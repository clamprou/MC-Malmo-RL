...
NUM_AGENTS = 1
NUM_MOBS = 3
UNRESPONSIVE_AGENT = 100 / (3 * MS_PER_TICK)
UNRESPONSIVE_ZOMBIES = 100 / MS_PER_TICK
...
class Agent:
    ...
    def play_action(self, action):
        ...
        self.malmo_agent.sendCommand("move " + str(action[0]))
        self.malmo_agent.sendCommand("strafe " + str(action[1]))
        self.malmo_agent.sendCommand("turn " + str(action[2]))
